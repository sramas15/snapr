...
namespace TSnap{
  ...
  template<class PGraph> PTable ToTable(PGraph G, int num_attrs);
...
public:
  ...
  template<class PGraph> friend
  PTable TSnap::ToTable(PGraph G, int num_attrs);

  //PTable friend TSnap::ConvertToTTable(int num_attrs);
